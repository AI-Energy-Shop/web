      ...
      <div className="inner-container max-w-[1200px] mx-auto pb-10 md:pt-10">
        <div className="upper-container w-full md:flex">
          ...
          <div className="w-full md:w-[36.6%] lg:w-[36.6%] hidden md:block text-center text-white">
            <h3 className={`${firaSansFont.className} text-center text-md font-bold mb-5`}>Locations</h3>
            <address
              className={`${muktaVaani.className} flex flex-col p-5 md:p-0 gap-4 lg:gap-5 text-[16px] leading-3`}
            >
              <div>
                <span className="font-bold">Melbourne:</span> 34/49 McArthurs Rd, Altona North VIC 3025
              </div>
              <div>
                <span className="font-bold">Sydney:</span> 24/32-38 Belmore Road, Punchbowl NSW 2196
              </div>
              <div>
                <span className="font-bold">Brisbane:</span> 3/22 Spine St, Sumner QLD 4074
              </div>
            </address>
          </div>
